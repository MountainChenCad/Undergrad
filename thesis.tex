...
\usepackage[ruled,linesnumbered]{algorithm2e} % Use algorithm2e, ruled adds lines, linesnumbered adds numbers

% Optional: Customize comment style for algorithm2e if needed
\SetCommentSty{textit} % Example: Set comment text to italics
\SetKwComment{Comment}{$\triangleright$\ }{} % Example: Use a triangle before comment
...
\author{陈凌峰}
\zhdate{\zhtoday}
\entitle{Few-shot Automatic Aero Target Recogniton Based on Meta-Learning}
